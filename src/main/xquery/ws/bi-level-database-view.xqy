...
declare function local:forest-stats($forestid as xs:unsignedLong) {
    array-node {
        ...
        return (
            (: object-node {"name": text{"Stands"}, "size": fn:count($x/f:stands-counts/()) },
            object-node {"name": text{"Documents"}, "size": fn:data($x/f:document-count) }, :)
            object-node {"name": text{"Active Fragments"}, "size": sum($x/f:stands-counts/f:stand-counts/f:active-fragment-count)},
            object-node {"name": text{"Deleted Fragments"}, "size": sum($x/f:stands-counts/f:stand-counts/f:deleted-fragment-count)},
            object-node {"name": text{"Deleted Fragments"}, "size": sum($x/f:stands-counts/f:stand-counts/f:nascent-fragment-count)}
        )
    }
};
